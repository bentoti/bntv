...
<head>
    ...
    <title>Pricing || Streamo - Media Streaming App Site Bootstrap 5 Template</title>
...
<div class="main-wrapper">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <ul class="breadcrumb-list">
                            ...
                            <li class="breadcrumb-item active">Our Pricing Plan</li>
                        </ul>
                        <!-- breadcrumb-list end -->
                    </div>
                </div>
    ...
    <main class="page-content">
        ...
        <div class="pricing-plan-area section-pt">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <!-- Pricing-panel -->
                        <div class="pricing-panel  mt--30 text-center">
                            <div class="pricing-heading">
                                <h2>$100</h2>
                                <h4>Premium</h4>
                            </div>
