...
<head>
    ...
    <title>Home Three || Streamo - Media Streaming App Site Bootstrap 5 Template</title>
...
<div class="main-wrapper">
    ...
    <main class="page-content-wrapper">
        ...
        <div class="hero-slider hero-slider-three">
            ...
            <div class="single-slide-3 d-flex align-items-center bg-image-two bg-color-two" data-bgimage="assets/images/slider/background-image-04.png">
                <!-- Hero Content One Start -->
                <div class="hero-content-three container-fluid">
                    <div class="row">
                        <div class="col-lg-12"> 
